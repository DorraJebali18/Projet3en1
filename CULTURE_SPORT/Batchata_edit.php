<?php
	...
	$sql = "SELECT * FROM Batchata where idBatchata = ?";
	$q = $pdo->prepare($sql);
...
<html>
	...
	<body>
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				<div class="row">
					<h3 align="center">Update Batchata</h3>
				</div>
		 
					<form class="form-horizontal" action="Batchata_data_edittb.php?id=<?php echo $idBatchata?>" method="post">
					<div class="control-group">
						<label class="control-label">Id Batchata</label>
						<div class="controls">
							<input name="idBatchata" type="text"  placeholder="" value="<?php echo $data['idBatchata'];?>" required>
						</div>
					</div>
					<div class="control-group">
		       ...
		       <div class="form-actions">
						...
						<a class="btn" href="Batchata_data.php">Back</a>
					</div>
				</form>
			</div>               
		</div> <!-- /container -->	
