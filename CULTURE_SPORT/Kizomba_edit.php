<?php
	...
	$sql = "SELECT * FROM Kizomba where idKizomba = ?";
	$q = $pdo->prepare($sql);
...
<html>
	...
	<body>
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				<div class="row">
					<h3 align="center">Update Kizomba</h3>
				</div>
		 
					<form class="form-horizontal" action="Kizomba_data_edittb.php?id=<?php echo $idKizomba?>" method="post">
					<div class="control-group">
						<label class="control-label">Id Kizomba</label>
						<div class="controls">
							<input name="idKizomba" type="text"  placeholder="" value="<?php echo $data['idKizomba'];?>" required>
						</div>
					</div>
					<div class="control-group">
		       ...
		       <div class="form-actions">
						...
						<a class="btn" href="Kizomba_data.php">Back</a>
					</div>
				</form>
			</div>               
		</div> <!-- /container -->	
