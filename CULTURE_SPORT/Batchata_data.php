...
<html>
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a class="active" href="Batchata_data.php">Batchata</a></li>
			<li><a  href="logout.php">logout</a></li>
		</ul>
            <div class="row">
                <h3>Batchata Data Table</h3>
            </div>
          ...
          <p>
                <table class="table table-striped table-bordered">
                  ...
                  <?php
                   ...
                   $sql = 'SELECT * FROM Batchata ORDER BY idBatchata ASC';
                   foreach ($pdo->query($sql) as $row) {
                            echo '<tr>';
						    echo '<td>'. $row['idBatchata'] . '</td>';
                            echo '<td>'. $row['nom'] . '</td>';
					        ...
					        echo '<td><a class="btn btn-success" href="Batchata_edit.php?idBatchata='.$row['idBatchata'].'">Edit</a>';
							echo ' ';
							echo '<a class="btn btn-danger" href="Batchata data delete page.php?idBatchata='.$row['idBatchata'].'">Delete</a>';
							echo '</td>';
                            echo '</tr>';
                   }
                   Database::disconnect();
