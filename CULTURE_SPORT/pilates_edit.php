<?php
	...
	$sql = "SELECT * FROM pilates where idpilates = ?";
	$q = $pdo->prepare($sql);
...
<html>
	...
	<body>
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				<div class="row">
					<h3 align="center">Update Pilates</h3>
				</div>
		 
					<form class="form-horizontal" action="pilates_data_edittb.php?id=<?php echo $idpilates?>" method="post">
					<div class="control-group">
						<label class="control-label">Id Pilates</label>
						<div class="controls">
							<input name="idpilates" type="text"  placeholder="" value="<?php echo $data['idpilates'];?>" required>
						</div>
					</div>
					<div class="control-group">
		       ...
		       <div class="form-actions">
						...
						<a class="btn" href="pilates_data.php">Back</a>
					</div>
				</form>
			</div>               
		</div> <!-- /container -->	
