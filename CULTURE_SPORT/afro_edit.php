<?php
	...
	$sql = "SELECT * FROM afro where idafro = ?";
	$q = $pdo->prepare($sql);
...
<html>
	...
	<body>
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				<div class="row">
					<h3 align="center">Update Afro</h3>
				</div>
		 
					<form class="form-horizontal" action="afro_data_edittb.php?id=<?php echo $idafro?>" method="post">
					<div class="control-group">
						<label class="control-label">Id Afro</label>
						<div class="controls">
							<input name="idafro" type="text"  placeholder="" value="<?php echo $data['idafro'];?>" required>
						</div>
					</div>
					<div class="control-group">
		       ...
		       <div class="form-actions">
						...
						<a class="btn" href="afro_data.php">Back</a>
					</div>
				</form>
			</div>               
		</div> <!-- /container -->	
