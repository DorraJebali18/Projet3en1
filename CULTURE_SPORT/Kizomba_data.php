          ...
          <p>
                <table class="table table-striped table-bordered">
                  ...
                  <?php
                   ...
                   $sql = 'SELECT * FROM Kizomba ORDER BY idKizomba ASC';
                   foreach ($pdo->query($sql) as $row) {
                            echo '<tr>';
						    echo '<td>'. $row['idKizomba'] . '</td>';
                            echo '<td>'. $row['nom'] . '</td>';
					        ...
					        echo '<td><a class="btn btn-success" href="Kizomba_edit.php?idKizomba='.$row['idKizomba'].'">Edit</a>';
							echo ' ';
							echo '<a class="btn btn-danger" href="Kizomba data delete page.php?idKizomba='.$row['idKizomba'].'">Delete</a>';
							echo '</td>';
                            echo '</tr>';
                   }
                   Database::disconnect();
