...
<html>
	...
	<body>
		...
		<div class="container">
		<ul class="topnav">
			<li><a class="active" href="salsa_data.php">Salsa</a></li>
          ...
          <p>
                <table class="table table-striped table-bordered">
                  ...
                  <?php
                   ...
                   $sql = 'SELECT * FROM salsa ORDER BY idsalsa ASC';
                   foreach ($pdo->query($sql) as $row) {
                            echo '<tr>';
						    echo '<td>'. $row['idsalsa'] . '</td>';
                            echo '<td>'. $row['nom'] . '</td>';
					        ...
					        echo '<td><a class="btn btn-success" href="salsa_edit.php?idsalsa='.$row['idsalsa'].'">Edit</a>';
							echo ' ';
							echo '<a class="btn btn-danger" href="user data delete page.php?idsalsa='.$row['idsalsa'].'">Delete</a>';
							echo '</td>';
                            echo '</tr>';
                   }
                   Database::disconnect();
