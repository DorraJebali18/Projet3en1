<?php
	...
	$sql = "SELECT * FROM salsa where idsalsa = ?";
	$q = $pdo->prepare($sql);
...
<html>
	...
	<body>
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				<div class="row">
					<h3 align="center">Update Salsa</h3>
				</div>
		 
					<form class="form-horizontal" action="salsa_data_edittb.php?id=<?php echo $idsalsa?>" method="post">
					<div class="control-group">
						<label class="control-label">Id Salsa</label>
						<div class="controls">
							<input name="idsalsa" type="text"  placeholder="" value="<?php echo $data['idsalsa'];?>" required>
						</div>
					</div>
					<div class="control-group">
		       ...
		       <div class="form-actions">
						...
						<a class="btn" href="salsa_data.php">Back</a>
					</div>
				</form>
			</div>               
		</div> <!-- /container -->	
